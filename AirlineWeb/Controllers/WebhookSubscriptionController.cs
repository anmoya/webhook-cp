...
namespace AirlineWeb.Controllers
{
    ...
    public class WebhookSubscriptionController : ControllerBase
    {
        ...
        {
            var subscription = _context.WebhookSubscriptions.Where(w => w.Secret == secret).FirstOrDefault();
        ...
        [HttpPost]
        public ActionResult<WebhookSubscriptionReadDto> PostAsync([FromBody] WebhookSubscriptionCreateDto webhookSubscriptionCreateDto)
        {
            var subscription = _context.WebhookSubscriptions.FirstOrDefault(s => s.Webhook.Equals(webhookSubscriptionCreateDto.Webhook));
            ...
            return CreatedAtRoute(nameof(GetSubscriptionBySecret), new { secret = readDto.Secret }, readDto);
        }
